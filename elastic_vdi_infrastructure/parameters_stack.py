...
class ParametersStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str,
        ...
        vdi_subnet_id = vpc.select_subnets(
            subnet_type=ec2.SubnetType.PRIVATE_WITH_NAT).subnet_ids[0]
    ...
    def create_parameters(
        ...
        ssm.StringParameter(
            ...
            string_value=iam.CfnInstanceProfile(
                self,
                "InstanceProfile",
                roles=[
                    role_dcv.role_name]).attr_arn)
