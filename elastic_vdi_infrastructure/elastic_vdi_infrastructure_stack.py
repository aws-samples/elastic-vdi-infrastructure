...
class ElasticVdiInfrastructureStack(Stack):
    ...
    def create_broker(
            ...
            role_broker,
            broker_security_group,
            broker_userdata_script):

        # Broker target groups
        broker_tg_8443 = elbv2.ApplicationTargetGroup(
            self,
            "broker_tg_8443",
        ...
        data_broker_format = str(data_broker,
                                 'utf-8').format(StackName=cdk.Aws.STACK_NAME,
        ...
        linux_ami_broker = ec2.AmazonLinuxImage(
        ...
        asg_broker = self.create_asg(
            "Broker",
            vpc,
            config['ec2_type_broker'],
            linux_ami_broker,
            broker_userdata,
            role_broker,
            config['key_name'],
            ...
            broker_security_group,
            "/dev/sda1",
            config['ebs_broker_size'],
            subnet_type)

        asg_broker.node.default_child.target_group_arns = [
            broker_tg_8443.target_group_arn, broker_tg_8445.target_group_arn]
    ...
    def create_enginframe(
        ...
        linux_ami_enginframe = ec2.AmazonLinuxImage(
            generation=ec2.AmazonLinuxGeneration.AMAZON_LINUX_2,
            edition=ec2.AmazonLinuxEdition.STANDARD,
            virtualization=ec2.AmazonLinuxVirt.HVM,
            storage=ec2.AmazonLinuxStorage.GENERAL_PURPOSE,
        ...
        # EnginFrame instance ASG
        asg_enginframe = self.create_asg(
            "Enginframe",
            vpc,
            config['ec2_type_enginframe'],
            linux_ami_enginframe,
            enginframe_userdata,
            role_ef,
            config['key_name'],
            1,
